...
if(($team != null) or ($day != null) or ($period != null)){
        $query = "INSERT INTO `timetable`(`id`, `id_team`, `id_disciplines`, `id_teacher`, `id_location`, `id_day`, `id_time`, `id_type`, `period_week`) VALUES 
        (NULL,'$team','$predmet','$prepod','$mesto','$day','$period','$tip', '$week')";
...
echo "<script>window.location.href='/administrator/constructor.php?name_group={$group}&week={$week}';</script>";
